# Generated by Django 3.2.10 on 2022-04-27 20:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('commentdislikes', models.ManyToManyField(blank=True, related_name='commentdislikes', to=settings.AUTH_USER_MODEL)),
                ('commentlikes', models.ManyToManyField(blank=True, related_name='commentlikes', to=settings.AUTH_USER_MODEL)),
